...
interface Callback<T> { // Generic-interface
    (err: Error | null, titles: T | null): void;
}

export { LibMgrCallback, Callback, ShelfItem, Magazine, Author, Book, Librarian, Person1, TOptions, A, DamageLogger as Logger }